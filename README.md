...
#### Notification System
 - When fire alarm is triggered, system will send notifications to user via email & Telegram Chat.
 - Email: Uses SMTP connected to Gmail to send an email
 - Telegram: Uses Telegram Bot to send a message
