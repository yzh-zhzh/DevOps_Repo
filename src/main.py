...
from Camera import camera_thread  # Commented out if not needed
...
def start_all_threads():
    ...
    Thread(target=camera_thread, args=(system_state,), daemon=True).start()  # Commented out if not needed
